...
interface DropDownProps {
    ...
    dispatch: React.Dispatch<{ type: "LOGIN"; payload: Payload } | { type: "LOGOUT" }>;
}
const DropDown: React.FC<DropDownProps> = ({ setDropDownOpen, dropdownOpen, state, dispatch }) => {
    return (
        <div className="absolute right-0 mt-2 w-60 bg-[#1e1e1e] shadow-xl rounded-md overflow-hidden border border-[#333333]">
            ...
            <div className="p-3 border-b border-[#333333]">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-white truncate">{state.mail}</p>
            ...
            {/* Menu options */}
            <div className="py-2" onClick={() => setDropDownOpen(!dropdownOpen)}>
                <Link
                    to="/profile"
